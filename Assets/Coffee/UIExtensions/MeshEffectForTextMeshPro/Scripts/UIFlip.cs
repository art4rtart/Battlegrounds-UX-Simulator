...
namespace her0in.UI
{
	...
	public class UIFlip : BaseMeshEffect
	{
		...
		//################################
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="her0in.UI.UIFlip"/> should be flipped horizontally.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="her0in.UI.UIFlip"/> should be flipped vertically.
		/// </summary>
		/// <value><c>true</c> if be flipped horizontally; otherwise, <c>false</c>.</value>
